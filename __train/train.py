...
saveModel = keras.callbacks.ModelCheckpoint('weights3epoch.{epoch:02d}.hdf5', monitor='epoch', verbose=1, save_best_only=False, save_weights_only=False, mode='auto', period=1)
