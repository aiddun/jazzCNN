...
I used the Keras Audio Preprocessor library, or "Kapre" by Keunwoo Choi, which allowed for a seamless converion of wavform audio samples to two-dimentional Mel series Spectrographs, allowing a normal 2D Convnet to train on the dataset while emulating human audio perception. I was rushed for time for many parts of this project so I appologize that my code isn't the as formidable as it should be.
